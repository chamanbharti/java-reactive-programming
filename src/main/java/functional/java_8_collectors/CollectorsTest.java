...
public class CollectorsTest {
    public static void main(String[] args) {
        ...
        List<Integer> toList = numbers.stream().filter(i -> i%2 !=0).collect(Collectors.toCollection(ArrayList::new));
        ...
        Set<Integer> toSet = numbers.stream().filter(i -> i%2 !=0).collect(Collectors.toCollection(HashSet::new));
